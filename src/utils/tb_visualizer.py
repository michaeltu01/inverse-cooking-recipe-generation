...
class Visualizer():
    ...
    def image_summary(self, mode, epoch, images):
        # pytorch: images = vutils.make_grid(images, normalize=True, scale_each=True)
        images = image_grid(images) # this helper doesn't do what the last two pytorch inputs would do
